...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'albinomouse' ),
		'cyrillic'     => __( 'Cyrillic', 'albinomouse' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'albinomouse' ),
		'devanagari'   => __( 'Devanagari', 'albinomouse' ),
		'greek'        => __( 'Greek', 'albinomouse' ),
		'greek-ext'    => __( 'Greek Extended', 'albinomouse' ),
		'khmer'        => __( 'Khmer', 'albinomouse' ),
		'latin'        => __( 'Latin', 'albinomouse' ),
		'latin-ext'    => __( 'Latin Extended', 'albinomouse' ),
		'vietnamese'   => __( 'Vietnamese', 'albinomouse' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'albinomouse' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'albinomouse' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'albinomouse' ),
