...
function albinomouseoptions_tabs() {
	$counter = 0;
	$albinomouseoptions_settings = get_option('options_framework_theme');
...
function albinomouseoptions_fields() {
	...
	foreach ( $options as $value ) {
		...
		// Uploader
		case "upload":
			$output .= albinomouseoptions_medialibrary_uploader( $value['id'], $val, null );
			break;
		...
		case 'background':
			...
			$output .= albinomouseoptions_medialibrary_uploader( $value['id'], $background['image'], null, '',0,'image');
...
add_action( 'albinomouseoptions_after','optionscheck_display_sidebar' );

function optionscheck_display_sidebar() { ?>
	<div id="albinomouseoptions-sidebar">
		<div class="metabox-holder">
			<div class="postbox">
				<h3><?php _e('AlbinoMouse Informations', 'albinomouse') ?></h3>
					<div class="inside">
						<div class="options-sidebar-section">
							<h4 class="options-sidebar"><?php _e('Documentation','albinomouse') ?></h4>
							<ul class="icons-ul">
								<li><span class="icon-info"></span> <a href="http://www.pixelstrol.ch/en/wp-themes/albinomouse/albinomouse-documentation/">Theme documentation [english]</a></li>
								<li><span class="icon-info"></span> <a href="http://www.pixelstrol.ch/wp-themes/albinomouse/albinomouse-dokumentation/">Theme Dokumentation [deutsch]</a></li>
							</ul>
						</div>
						
						<div class="options-sidebar-section">
							<h4 class="options-sidebar"><?php _e('Bugs','albinomouse') ?></h4>
							<ul class="icons-ul">
								<li><span class="icon-bug"></span> <?php _e('Report a bug on <a href="https://github.com/pixelstrolch/AlbinoMouse/issues">github</a>', 'albinomouse') ?></li>
								<li><span class="icon-bug"></span> <?php _e('Report a bug on <a href="http://wordpress.org/support/theme/albinomouse/">the forum</a>', 'albinomouse') ?></li>
								<li><span class="icon-changelog"></span> <a href="https://github.com/pixelstrolch/AlbinoMouse/blob/master/changelog.txt">Changelog</a></li>						
							</ul>
						</div>
						
						<div class="options-sidebar-section">
							<h4 class="options-sidebar"><?php _e('Review','albinomouse') ?></h4>			
							<ul class="icons-ul">
								<li><span class="icon-star"></span> <a href="http://wordpress.org/support/view/theme-reviews/albinomouse"><?php _e('Please rate AlbinoMouse on wordpress.org.', 'albinomouse') ?></a></li>
							</ul>
						</div>
