...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'albinomouse'),
		'repeat-x'  => __('Repeat Horizontally', 'albinomouse'),
		'repeat-y'  => __('Repeat Vertically', 'albinomouse'),
		'repeat'    => __('Repeat All', 'albinomouse'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'albinomouse'),
		'top center'    => __('Top Center', 'albinomouse'),
		'top right'     => __('Top Right', 'albinomouse'),
		'center left'   => __('Middle Left', 'albinomouse'),
		'center center' => __('Middle Center', 'albinomouse'),
		'center right'  => __('Middle Right', 'albinomouse'),
		'bottom left'   => __('Bottom Left', 'albinomouse'),
		'bottom center' => __('Bottom Center', 'albinomouse'),
		'bottom right'  => __('Bottom Right', 'albinomouse')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'albinomouse'),
		'fixed'  => __('Fixed in Place', 'albinomouse')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'albinomouse'),
		'italic'      => __('Italic', 'albinomouse'),
		'bold'        => __('Bold', 'albinomouse'),
		'bold italic' => __('Bold Italic', 'albinomouse')
		);
